...
function CursorCore(_a) {
    ...
    var _p = useState(false), isActiveClickable = _p[0], setIsActiveClickable = _p[1];
    var endX = useRef(0);
    var endY = useRef(0);
    /**
    ...
    return (jsxs(Fragment, { children: [jsx("div", { ref: cursorOuterRef, style: styles.cursorOuter }), jsx("div", { ref: cursorInnerRef, style: styles.cursorInner })] }));
}
/**
 * AnimatedCursor
...
function AnimatedCursor(_a) {
    ...
    return (jsx(CursorCore, { clickables: clickables, color: color, innerScale: innerScale, innerSize: innerSize, innerStyle: innerStyle, outerAlpha: outerAlpha, outerScale: outerScale, outerSize: outerSize, outerStyle: outerStyle, showSystemCursor: showSystemCursor, trailingSpeed: trailingSpeed }));
}
